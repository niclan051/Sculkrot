...
@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, modid = Sculknrun.MODID)
public final class ModPacketPayloads {
    public static final LodestoneNetworkPayloads.PayloadRegistryHelper CHANNEL =
            new LodestoneNetworkPayloads.PayloadRegistryHelper(Sculknrun.MODID);
    ...
    public static void register(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(
                ...
                (payload, context) -> Sculknrun.infectionLevel = payload.infectionLevel()
        );
